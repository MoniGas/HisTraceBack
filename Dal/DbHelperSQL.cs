...
namespace Dal
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static bool Exists(DbTransaction tran, string strSql, params SqlParameter[] cmdParms)
        {
            object obj = GetSingle(tran, strSql, cmdParms);
            int cmdresult;
            if ((Equals(obj, null)) || (Equals(obj, DBNull.Value)))
            {
                cmdresult = 0;
        ...
        {
            string sqlCount = string.Format("SELECT COUNT(1) Count FROM ({0}) T", sql);
            object obj = GetSingle(sqlCount);
            if (obj == null)
            {
                return 0;
            }
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(DbTransaction tran, string SQLString, params SqlParameter[] cmdParms)
        {
            return ExecuteNonQuery(tran, CommandType.Text, SQLString, cmdParms);
        }
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(DbTransaction tran, string SQLString, params SqlParameter[] cmdParms)
        {
            return ExecuteScalar(tran, CommandType.Text, SQLString, cmdParms);
        }
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(DbTransaction tran, string SQLString, params SqlParameter[] cmdParms)
        {
            return ExecuteDataset(tran, CommandType.Text, SQLString, cmdParms);
        }
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, string cnnstr)
        {
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString,string cnnstr,string i="")
        {
            using (SqlConnection connection = new SqlConnection(cnnstr))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
