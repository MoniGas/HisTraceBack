...
namespace Common.ToolApproach
{
    public class FileControl
    {
        ...
        *****************************************/
        ...
        public static void WriteFile(string Path, string Strings, Encoding ending)
        {
            ...
            System.IO.StreamWriter f2 = new System.IO.StreamWriter(Path, true, ending);
        ...
        *****************************************/
        ...
        /// <param name="dirPath">文件夹路径</param>
        /// <returns></returns>
        public static double GetDirectoryLengthWithM(string dirPath)
        {
            double len = Convert.ToDouble(GetDirectoryLength(dirPath));
            int unit = 1024 * 1024;
            return Math.Round(len / unit, 2);
        }
        #endregion
        ...
        *****************************************/
        ...
        /// <summary>
        /// 返回指定目录下所有文件信息(只取得当前目录下的文件列表)  
        /// </summary>
        /// <param name="strDirectory"></param>
        /// <returns></returns>
        public static List<FileInfo> GetAllFilesInDirectory1(string strDirectory)
        {
