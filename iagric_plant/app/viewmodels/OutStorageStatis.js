define(['plugins/router', 'knockout', 'knockout.mapping', 'jquery', 'jqPaginator', 'plugins/dialog', 'utils', 'logininfo', './OutStorageDetail'],
    function (router, ko, km, $, jq, dialog, utils, loginInfo, outstoragedetail) {
        var moduleInfo = {
            moduleID: '61600',
