define(['plugins/router', 'knockout', 'knockout.mapping', 'jquery', 'jqPaginator', 'logininfo', './brand_add', './brand_edit', 'plugins/dialog', 'utils'], function (router, ko, km, $, jq, loginInfo, brand_add, brand_edit, dialog, utils) {
    var moduleInfo = {
        moduleID: '10900',
    ...
    var editBrand = function (id, data, event) {
        ...
        brand_edit.show(id).then(function (BrandName, Descriptions, logo, type) {
            if (type == 2) {
        ...
        //        brand_edit.show(id).then(function () {
        //            searchBrand();
        //        });
    };
    //删除品牌
