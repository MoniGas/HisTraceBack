define(['plugins/router', 'plugins/dialog', 'knockout', 'knockout.mapping', 'jqPaginator', 'logininfo', './euserresetpass', './enterpriseuserSub_add', './enterpriseuserSub_edit', './enterpriseuser_see', "./enterpriseuser_level_see", 'utils'],
function (router, dialog, ko, km, jq, loginInfo, euserresetpass, enterpriseuser_add, enterpriseuser_edit, enterpriseuser_see, enterpriseuser_level_see, utils) {
    ...
    var getData = function (pageIndex) {
        ...
        $.ajax({
            type: "POST",
            url: "/Admin_Enterprise_User/GetSubList",
