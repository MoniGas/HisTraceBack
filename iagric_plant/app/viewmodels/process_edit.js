define(['plugins/router', 'knockout', 'jquery', 'knockout.validation', 'utils', 'logininfo', 'plugins/dialog', 'jquery-ui', './operationsShow'],
    function (router, ko, $, kv, utils, loginInfo, dialog, jqueryui, operationsShow) {
        ...
        var vm = function (id) {
            ...
            self.processOps = ko.observableArray([]);
            self.selectprocessOps = ko.observableArray();
            self.selectedOp = ko.observable(0);
            ...
            self.init = function () {
                ...
                $.ajax({
                    ...
                    success: function (jsonResult) {
                        ...
                        self.processName(jsonResult.ObjModel.ProcessName);
                        self.selectprocessOps(jsonResult.ObjModel.operations);
            ...
            self.EditProcess = function (data, event) {
